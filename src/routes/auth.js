...
router.post(
  ...
  ah(async (req, res, next) => {
    ...
    if (val.ok && (await usersModel.byEmail(email))) {
    ...
    const user = await usersModel.create({ email, password, displayName });
...
router.post(
  ...
  ah(async (req, res, next) => {
    ...
    const user = await usersModel.byEmail(email);
...
router.post(
  ...
  ah(async (req, res, next) => {
    ...
    const user = await usersModel.byId(pending.userId);
